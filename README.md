...
This repository contains the Source Code for the Tip Calculator App from 🧑🏻‍💻 [Claude Code: AI Crash Course for Developers](https://linkly.link/2gkkw) course.
...
📺 [Claude Code: AI Crash Course for Developers](https://linkly.link/2gkkw)
...
1. Open repository main [page](https://github.com/dvasyliev/claude-code-tip-calculator).
...
1. Open [commits](https://github.com/dvasyliev/claude-code-tip-calculator/commits/main/) page.
...
Open [http://localhost:5173](http://localhost:5173) to view it in your browser (or use PORT you provided in `.env` file.
